...
#Une hypocycloïde est une courbe plane transcendante, trajectoire d'un point fixé à un cercle
#qui roule sans glisser sur un autre cercle dit directeur et à l'intérieur de celui-ci.
